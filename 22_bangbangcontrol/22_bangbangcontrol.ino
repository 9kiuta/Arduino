...
#define _DUTY_MAX 2348 // 2000
#define _DUTY_NEU 1480 // 1500
#define _DUTY_MIN 500 // 1000

#define _SERVO_ANGLE_DIFF  156  // Replace with |D - E| degree
#define _SERVO_SPEED       480  // servo speed
...
float volt_to_distance(int x)
{
  ...
  return 1181 + (-6.14) * x + 0.0116 * x * x + (-7.64E-06) * x * x * x;
}
